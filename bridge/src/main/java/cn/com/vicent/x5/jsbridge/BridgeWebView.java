...
public class BridgeWebView extends WebView implements WebViewJavascriptBridge {
	...
	Map<String, JsBridgeHandler> messageHandlers = new HashMap<String, JsBridgeHandler>();
	JsBridgeHandler defaultHandler = new JsDefaultHandler();
	JsBridgeHandler jsDefaultHandler = new JsDefaultHandler();
	...
	void handlerReturnData(String url) {
		...
		LUtil.e("handlerReturnData"+functionName);
	...
	void dispatchMessage(Message m) {
        ...
        LUtil.e("dispatchMessage："+messageJson);
	...
	public void loadUrl(String jsUrl, CallBackFunction returnCallback) {
		...
		LUtil.e("loadUrl:"+BridgeUtil.parseFunctionName(jsUrl));
	}
